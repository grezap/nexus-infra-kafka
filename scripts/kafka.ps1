...
.PARAMETER Phase
  Which smoke phase to run. '0.H.2' (default) is the active phase;
  '0.H.1' is kept for re-running the PLAINTEXT bring-up gate (valid only
  before 0.H.2 flips the clusters to mTLS). Later sub-phases add their own
  gates.
